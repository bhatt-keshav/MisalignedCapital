...
saudi_cds_10y <- calc_price_delta(data = saudi_cds_10y, date_col = "Date", price_col = "Price", output_col = "d_cds")
...
us_10y <- calc_price_delta(data = us_10y, date_col = "Date", price_col = "Price", output_col = "d_10y")
